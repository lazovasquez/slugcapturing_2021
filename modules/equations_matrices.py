...
if system == 2:
   # Amat
    ...
    def Cmat3_fenics (var1, var2, var3, var4):
        return -sin(beta)*g +\
             (tau_gl_fenics (var1, var2, var3, var4)*P_gl_fenics (var1)/A + tau_gw_fenics (var1, var3, var4)*P_gw (var1)/A)/(rho_g (var4)*(-1 + var1))
